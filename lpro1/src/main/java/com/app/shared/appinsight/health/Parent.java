...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "shweta.zagade@algorhythm.co.in", versionNumber = "2", comments = "Parent", complexity = Complexity.LOW)
...
public class Parent implements Serializable, CommonEntityInterface, Comparator<Parent> {
    ...
    public void setParentAge(Integer _parentAge) {
        if (_parentAge != null) {
            this.parentAge = _parentAge;
        }
    }
