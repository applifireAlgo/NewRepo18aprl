Ext.define('Lpro1.lpro1.web.com.controller.appinsight.health.ParentMainController', {
     extend: 'Lpro1.view.fw.frameworkController.AggregateViewController',
     ...
     onFilterClick: function(but, evt) {
          ...
          Ext.Ajax.request({
               ...
               failure: function(response, currentObject) {
                    ...
                    var compRef = scope.sender.view.down('#ParentTree');
