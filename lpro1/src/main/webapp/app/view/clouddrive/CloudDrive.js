Ext.define("Lpro1.view.clouddrive.CloudDrive", {
	extend : 'Ext.panel.Panel',
	xtype : 'clouddrive',
	requires : [ 'Lpro1.view.clouddrive.CloudDriveController',
	             'Lpro1.view.clouddrive.documentview.DocumentsView',
	             'Lpro1.view.clouddrive.drivedetails.DriveDetails',
	             //'Lpro1.view.clouddrive.documentview.DocumentListView'
	             ],
