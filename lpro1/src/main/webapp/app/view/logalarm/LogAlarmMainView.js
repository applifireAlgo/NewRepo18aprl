 ...
 * 
 */
Ext.define('Lpro1.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Lpro1.view.logalarm.LogAlarmMainViewController',
			'Lpro1.view.logalarm.tree.LogAlarmTreePanel',
			'Lpro1.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
