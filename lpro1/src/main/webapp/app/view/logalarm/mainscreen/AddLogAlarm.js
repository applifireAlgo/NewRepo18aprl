 ...
 * 
 */
Ext.define('Lpro1.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Lpro1.view.logalarm.mainscreen.AddLogAlarmController',
			'Lpro1.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Lpro1.view.logalarm.mainscreen.AppAlarmPanel',
