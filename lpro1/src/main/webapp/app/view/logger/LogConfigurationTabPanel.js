...
Ext
		.define(
				'Lpro1.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Lpro1.view.logger.tabs.details.DetailsTab',
							'Lpro1.view.logger.tabs.fileconnector.FileConnectorTab',
							'Lpro1.view.logger.tabs.dbconnector.DBConnectorTab',
							'Lpro1.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Lpro1.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Lpro1.view.logger.LogConfigurationTabPanelController',
