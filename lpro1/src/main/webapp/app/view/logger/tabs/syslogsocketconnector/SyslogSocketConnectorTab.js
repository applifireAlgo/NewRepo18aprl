 ...
 * 
 */
Ext.define('Lpro1.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Lpro1.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
