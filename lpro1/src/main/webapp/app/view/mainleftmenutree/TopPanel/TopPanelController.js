Ext.define('Lpro1.view.mainleftmenutree.TopPanel.TopPanelController', {
	...
	onCloudClick : function()
	{
		var component = Ext.create(
				"Lpro1.view.clouddrive.CloudDrive", {
					closable : true,
					title : "Cloud Drive"
					//refId : "-1"
				});
	...
	{
		var component = Ext.create(
				"Lpro1.view.usermanagement.enduser.UserProfile", {
					closable : true,
					title : "My Profile"
				});
	...
	{
		var component = Ext.create(
				"Lpro1.view.usermanagement.enduser.ChangePwd", {
					closable : true,
