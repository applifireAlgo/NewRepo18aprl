Ext
		.define(
				'Lpro1.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Lpro1.view.searchengine.search.SearchEngineMainPanelController','Lpro1.view.searchengine.search.PanelHeaderField' ,'Lpro1.view.searchengine.search.ReportGridView','Lpro1.view.searchengine.search.ReportChartView','Lpro1.view.searchengine.search.documentView','Lpro1.view.searchengine.search.DouMeanView','Lpro1.view.googlemaps.map.MapPanel'],
