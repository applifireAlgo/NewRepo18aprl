Ext.define('Lpro1.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Lpro1.view.searchengine.search.NorthPanel', 'Lpro1.view.searchengine.search.SearchResult','Lpro1.view.searchengine.search.SearchEngineMainPanelController'],
