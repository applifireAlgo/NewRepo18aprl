 ...
 * 
 */
Ext.define('Lpro1.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Lpro1.view.securityconfig.SecurityConfigController',
			'Lpro1.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
