Ext.define('Lpro1.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Lpro1.view.usermanagement.admin.UserPasswordReset',
	            'Lpro1.view.usermanagement.admin.AddUserDetails',
	            'Lpro1.view.usermanagement.admin.ViewUser'],
