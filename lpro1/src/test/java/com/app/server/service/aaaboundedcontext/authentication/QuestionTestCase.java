...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws SpartanPersistenceException, SpartanConstraintViolationException {
        ...
        question.setQuestionIcon("AVUxTNxyuf050xLv0UNbxIbEfSDRzEOCsTycjpyXEQWS1tpjXP");
        question.setLevelid(9);
        question.setQuestionDetails("K1OBXCs84r");
        question.setQuestion("4IFb7Fk6cKTBI3ek3j2s50z5S7siXpHncVbrkKRYBi6UBFLG2V");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestionIcon("Y7QeecIeDmNfGhF51jXuzG7TI8v8eh2aR4UOIITaMxms88vk9q");
            question.setLevelid(11);
            question.setQuestionDetails("6Kk7yX2Sv3");
            question.setQuestion("z0qaSJUwQ6UDNDlHMfdUFDxV4xZT7DR1jwt3Q53mPx04p86qcL");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "eWeErwPjBzcU4F9QZCmglzFenzbPXeWVZITNQbNqg3Yd4IMNtsOIHMYvJ15ayT7cJ"));
