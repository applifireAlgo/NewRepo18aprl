...
public class UserTestCase extends EntityTestCriteria {
    ...
    private User createUser(Boolean isSave) throws SpartanPersistenceException, SpartanConstraintViolationException {
        ...
        useraccesslevel.setLevelDescription("gbLe8aEKEIFRBykpnWEm0opwNju5YH8BhKMUWXz88e2YGN6BwL");
        useraccesslevel.setLevelHelp("EdIk9AALuQPMNuOy4hZIUzmFwnKC3iWRwLpqArSbrEpFKHH1eD");
        useraccesslevel.setLevelIcon("8P6RQjONLR3yOh10PGEBxBMcU56S5DsCm1BvcBWg8vINGTjjrp");
        useraccesslevel.setLevelName("5DpPezpgkzSN6hOCfpixJdhvs8dS3XTJIL0HRPnakV9YvOmkzL");
        ...
        useraccessdomain.setDomainHelp("p6I13syub2XtKezpgBd6LsLZMU5POwCgYVZNK8KLWpjcv7re0n");
        useraccessdomain.setDomainIcon("uA7LxvdJuCYfPL1MJtFc8o4Vp3zXAfBMV16v9Yzs5FeTAwuuvN");
        useraccessdomain.setDomainName("CVUqWIoktTIOwNZ7uriEo0DmePxQnbInkDEcQkh5qrCWijyyWV");
        useraccessdomain.setDomainDescription("vL8kUxbGZD7GkWbQe8hSNoKxByRTlkOHK3NlK45JimTkoAhcct");
        ...
        User user = new User();
        user.setUserAccessCode(17657);
        user.setPasswordExpiryDate(new java.sql.Timestamp(1461062449716l));
        user.setIsLocked(1);
        ...
        user.setSessionTimeout(3331);
        user.setLastPasswordChangeDate(new java.sql.Timestamp(1461062449768l));
        user.setPasswordAlgo("1htR04NZPhx3L0vRTya3vkxFu86vLL2qzgFgCnWQLDTUOIioJg");
        user.setUserAccessDomainId((java.lang.String) UserAccessDomainTest._getPrimarykey()); /* ******Adding refrenced table data */
        java.util.List<PassRecovery> listOfPassRecovery = new java.util.ArrayList<PassRecovery>();
        PassRecovery passrecovery = new PassRecovery();
        Question question = new Question();
        question.setQuestionIcon("03pXektPvV0syEMRsG8JCSB7A0DWTEhkHpJOVB1At8gC4aysd8");
        question.setLevelid(11);
        question.setQuestionDetails("vTJN9SFEUd");
        question.setQuestion("RUumNgcuQCvAfaRrB2Kpbxlx1uJ2HvNESmuBfOgcNf7PX7Mlwf");
        ...
        passrecovery.setAnswer("c3sLpUrQ4P5odFNwjha6PEnClTUG57qIFRoHUiesOa1MkaBfMr");
        passrecovery.setQuestionId((java.lang.String) QuestionTest._getPrimarykey());
        listOfPassRecovery.add(passrecovery);
        user.addAllPassRecovery(listOfPassRecovery);
        UserData userdata = new UserData();
        userdata.setUser(user);
        userdata.setOneTimePassword("WKAJ2istaWg9F3HsOepzGbrp6zqCHAXo");
        userdata.setPassword("b9DRD6e6AOACsM0fCX01HfmPA4ibWINi8MRDttzoc9cg46uRIo");
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1461062450026l));
        userdata.setOneTimePasswordExpiry(1);
        userdata.setLast5Passwords("jZxO1fc682mYIaVqFnUdmpQkKP5Rx1X1ltsAgRH3lzoMlJQHTf");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 1, "userAccessCode", 71813));
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 8, "passwordAlgo", "U0GKdfkNdjWx0izRylHuX3GfIH8ZQPmjIdp4UJHwiPlDcf4i2O9Yn6EOOp8pOneAu"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 9, "sessionTimeout", 5203));
