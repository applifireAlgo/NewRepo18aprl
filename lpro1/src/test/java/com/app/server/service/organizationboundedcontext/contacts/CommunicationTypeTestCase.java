...
public class CommunicationTypeTestCase extends EntityTestCriteria {
    ...
    private CommunicationType createCommunicationType(Boolean isSave) throws SpartanPersistenceException, SpartanConstraintViolationException {
        ...
        communicationgroup.setCommGroupName("KM3WdnKyqID2apltaFGN9zuuEqbEwzaffqzyddLjeY7UyyYoGc");
        communicationgroup.setCommGroupDescription("7d8GBw4PSAPreoV1F6ppS8maVsW85brJaOpOj8oDXuUyeJ0SPy");
        ...
        communicationtype.setCommTypeDescription("Dg15WS7gR5Vr6YTPeH2191zzqcT9BTmDwNqWNVHWzG03XgDSyn");
        communicationtype.setCommGroupId((java.lang.String) CommunicationGroupTest._getPrimarykey());
        communicationtype.setCommTypeName("0SCPBYD1cH73DTTfXh40GFfpJ4PvnvnNblACxYEb5SHaSOC0AO");
    ...
    public void test2Update() {
        try {
            ...
            communicationtype.setCommTypeDescription("hQ5iII8XtyMQ1oof9zSLaXC6AFxeR2q2CGqoePnGwtCt1XqMye");
            communicationtype.setCommTypeName("CL867AOZgu26yfwjZb9kEAV8qvXHgyTwSSWBiqo0rwhzjiYf67");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "commTypeName", "28s8BfRgpXuGRV3k49v7gAYeCSD29ciUelgW9k6MoEyYIXdyeyAq9qE5ULES4unL8Rkh0ZykjZbgyw08gzndNlCHs3ERTTXLN8okkr9ws7coUFDmov9fDp8gknHFXYtZP"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 3, "commTypeDescription", ""));
