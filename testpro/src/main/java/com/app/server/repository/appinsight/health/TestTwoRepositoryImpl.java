...
@Repository
@SourceCodeAuthorClass(createdBy = "shweta.zagade1209@gmail.com", updatedBy = "", versionNumber = "1", comments = "Repository for TestTwo Master table Entity", complexity = Complexity.LOW)
public class TestTwoRepositoryImpl extends SearchInterfaceImpl implements TestTwoRepository<TestTwo> {
    ...
    @Transactional
    public TestTwo findById(String ttid) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
