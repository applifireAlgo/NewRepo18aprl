...
public class TestOneServiceImpl extends TestOneService {
    ...
    public HttpEntity<ResponseBean> findByGen(@RequestBody FindByBean findByBean) throws Exception {
        ...
        List<com.app.shared.appinsight.health.TestOne> lsttestone = testOnerepo.findByGen((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("AISHI124100200");
    ...
    public HttpEntity<ResponseBean> findByAddressId(@RequestBody FindByBean findByBean) throws Exception {
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        List<com.app.shared.appinsight.health.TestOne> lsttestone = testOnerepo.findByAddressId((java.lang.String) findByBean.getFindKey());
        AppAlarm appAlarm = Log.getAlarm("AISHI124100200");
        com.athena.framework.server.bean.ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "TestOne"));
        responseBean.add("data", lsttestone);
