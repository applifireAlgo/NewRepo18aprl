...
@SourceCodeAuthorClass(createdBy = "shweta.zagade1209@gmail.com", updatedBy = "", versionNumber = "1", comments = "TestTwo", complexity = Complexity.LOW)
@NamedQueries({ @javax.persistence.NamedQuery(name = "TestTwo.findById", query = "select e from TestTwo e where e.systemInfo.activeStatus=1 and e.ttid =:ttid") })
