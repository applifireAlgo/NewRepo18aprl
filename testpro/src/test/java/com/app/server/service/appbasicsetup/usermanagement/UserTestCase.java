...
public class UserTestCase extends EntityTestCriteria {
    ...
    private User createUser(Boolean isSave) throws Exception {
        ...
        useraccesslevel.setLevelHelp("pxy1yd8nVwB5bK4nAAUFnMXXEo7255P3Y8NcSGV2e2FcPjZrpF");
        useraccesslevel.setUserAccessLevel(valueGenerator.getRandomInteger(99999, 0));
        useraccesslevel.setLevelIcon("SbCokDSf69OSgiqx03lD5WJl749MaADwaWBIFsVRApornb7Rgz");
        useraccesslevel.setLevelDescription("DGrqOxre54WPOTVQ50XNwmMJH3bl6cYwHlFlubDudVFKDwbFmp");
        useraccesslevel.setLevelName("FtAUIdaDe5EIMZtuu5Hlaa1KZDw7g8T0jlYTipqQEXca0Lc83D");
        ...
        useraccessdomain.setDomainHelp("paK69wGBcLKrEyTGOeULWaCRcDcZg5EYiHlTRcUtnVa0xScMNM");
        useraccessdomain.setDomainName("yX7fZE380zdGw2vzX0jpeDsdOSBf1Wpef5MMJubiM7fr988roQ");
        useraccessdomain.setDomainDescription("0LBvNCIg2TKKPQt2q2iKpiYCNWCAHsrNG7nMzIcMkl8gqynHBw");
        useraccessdomain.setUserAccessDomain(valueGenerator.getRandomInteger(99999, 0));
        useraccessdomain.setDomainIcon("RNRqqt9h9vSvqypsNS95iH5AYpDda5u4xP0V8vpbZMNo9uoBRd");
        ...
        user.setPasswordAlgo("67FRXeNnyQz0YYEiPVHE3oGWRDxZVTYohVn9aeAnxjch6Ov4yK");
        user.setUserAccessDomainId((java.lang.String) UserAccessDomainTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setIsLocked(1);
        user.setLastPasswordChangeDate(new java.sql.Timestamp(1462363219517l));
        user.setIsDeleted(1);
        user.setPasswordExpiryDate(new java.sql.Timestamp(1462363219517l));
        user.setUserAccessCode(2143);
        user.setSessionTimeout(3486);
        ...
        question.setQuestion("oFPCRP7Y9DfcS4CqY0RjiYsErX1Tnkdbavr4oEjQoZY028pS50");
        question.setLevelid(1);
        question.setQuestionIcon("pOmtCcyjnPDsGiHHAsGAbepRqwMnYT93U0jJEJeOWnokyn80qf");
        question.setQuestionDetails("dkiLySP5NI");
        ...
        passrecovery.setAnswer("tWEym6hdf582Y5VXVVOCCn0HgF646WGTThogu6m6ZMt3n809dK");
        passrecovery.setQuestionId((java.lang.String) QuestionTest._getPrimarykey());
        listOfPassRecovery.add(passrecovery);
        user.addAllPassRecovery(listOfPassRecovery);
        UserData userdata = new UserData();
        userdata.setOneTimePasswordExpiry(8);
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1462363219732l));
        userdata.setOneTimePasswordExpiry(7);
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1462363219745l));
        userdata.setUser(user);
        userdata.setPassword("DXvnOTYYOdjHOpa1D6Dve1X8VbJBr2VBEx3Inz77EMUKRSyjBN");
        userdata.setLast5Passwords("TwtTfFJY3F5LvSoD2Eq5HKFm2ae7eiYhgGKutgeqofsNwPuvUn");
        userdata.setOneTimePassword("MqyLStpOU66hmXGoz0P6PLJtU3Bv8LwA");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 1, "userAccessCode", 68027));
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 8, "passwordAlgo", "NNfqbigy881jv1v6ueYImUu60m36qQQXDlmnmnluQij2mdIJCd7m7k7rYkF01CDi1"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 9, "sessionTimeout", 4460));
