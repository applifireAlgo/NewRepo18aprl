...
public class ContactTypeTestCase extends EntityTestCriteria {
    ...
    private ContactType createContactType(Boolean isSave) throws Exception {
        ...
        contacttype.setContactType("MUDN9TIsEKQUmBYEf1LbEj9FrFRoivfVjZogif9u2gQ3Krhmxp");
        contacttype.setContactTypeDesc("8WBwQ2bXTAhCzG6GJRu4wJTxPILKb4SL2l2k9jGhOUrTAw9Ttd");
        contacttype.setContactTypeIcon("1E84Pw3PKrOqcrijlxgYZNuUoleDPgmdUJTj5IUe9RjzfwuyGZ");
    ...
    public void test2Update() {
        try {
            ...
            contacttype.setContactType("gGxPhQLW6prWPXVVzcmo52syhmU5CYI6KMEYCmJ5GnaQNaC0oX");
            contacttype.setVersionId(1);
            contacttype.setContactTypeDesc("MOyMMM12pwuEGYQ0Xr74uIkkHgvNhSPh8xzanVmNWsEiJxpGrY");
            contacttype.setContactTypeIcon("uYkRfksigLpaZfhYSU3XI3EXhlHkN1et0NVLQt1tuOkI86s8Vp");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "contactType", "8nwv8XraaPUUwX8NNmrSTGW64L2ImJpfGsrS112dGDPxae6anBJkX6InCtIJlHK5uuN6Kaa458fV6cvxFa7XSFkpu5gJlNAU1WnLjv7XVhaleiHLPdEUfMDREPR2Tpfrd"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 3, "contactTypeDesc", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "contactTypeIcon", "6mH6TpssLhBBLld2azAy3dHOND8xfjYQSaKY9RoJuJfyhtxDU6IfYRBfnZnQrFpCmqD0t6vIpAo35zZZyjhs1ppPjuOt0d4ObVI3GOnrhi3NypHySfC19avv8bWYyPqyV"));
