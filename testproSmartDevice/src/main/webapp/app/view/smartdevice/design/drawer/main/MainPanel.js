Ext.define('Testpro.view.smartdevice.design.drawer.main.MainPanel', {
    extend : 'Ext.panel.Panel',
    xtype : 'mainPanel',
    requires : ['Testpro.view.smartdevice.searchengine.SearchEngineMainView','Testpro.view.smartdevice.design.drawer.main.MainPanelController','Testpro.view.smartdevice.design.resource.AppFormsList'],
    userinfo:{},
    id:'mainPanel',
