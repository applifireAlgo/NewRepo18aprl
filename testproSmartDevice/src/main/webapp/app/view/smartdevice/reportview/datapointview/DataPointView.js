Ext.define('Testpro.view.smartdevice.reportview.datapointview.DataPointView', {
	extend : 'Ext.panel.Panel',
	requires:['Testpro.view.smartdevice.reportview.datapointview.DataPointViewController'],
