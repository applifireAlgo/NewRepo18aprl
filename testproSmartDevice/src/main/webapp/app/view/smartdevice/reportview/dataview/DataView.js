Ext.define('Testpro.view.smartdevice.reportview.dataview.DataView', {
	extend : 'Ext.panel.Panel',
	requires:['Testpro.view.smartdevice.reportview.dataview.DataViewController','Testpro.view.smartdevice.reportview.dataview.DataDetailViewModel'],
	...
	items : [
	    {
	    	...
	    	store:{
	            ...
	            proxy: {
                    type: "ajax",
                    url: AppRestUrl+"secure/queryExecutor/getDataForMobile",
                    method:"POST",
                    jsonData : {id:""},
					extraParams: {id:""},
                    paramsAsJson:true,
