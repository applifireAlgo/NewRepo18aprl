Ext.define('Testpro.view.smartdevice.reportview.querycriteria.QueryCriteria', {
	extend : 'Ext.panel.Panel',
	requires:['Testpro.view.smartdevice.reportview.querycriteria.QueryCriteriaController'],
