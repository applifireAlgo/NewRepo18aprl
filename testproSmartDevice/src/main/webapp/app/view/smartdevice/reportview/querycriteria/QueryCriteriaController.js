Ext.define('Testpro.view.smartdevice.reportview.querycriteria.QueryCriteriaController',{
	extend :'Testpro.view.smartdevice.reportview.ReportMainViewController',
	...
	onApplyCriteriaBtnClick : function(){
		...
		Ext.Ajax.request({
			url:AppRestUrl+'secure/reportViewController/updateSearchCriteriaInSession',
			method:'POST',
