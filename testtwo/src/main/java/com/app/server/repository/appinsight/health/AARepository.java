...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for AA Master table Entity", complexity = Complexity.LOW)
public interface AARepository<T> extends SearchInterface {
    ...
    public T findById(String aaa) throws Exception, SpartanPersistenceException;
}
