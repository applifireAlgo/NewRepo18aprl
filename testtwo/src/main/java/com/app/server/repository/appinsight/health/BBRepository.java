...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for BB Master table Entity", complexity = Complexity.LOW)
public interface BBRepository<T> extends SearchInterface {
    ...
    public T findById(String bbid) throws Exception, SpartanPersistenceException;
}
