...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for Dsds Master table Entity", complexity = Complexity.LOW)
public interface DsdsRepository<T> extends SearchInterface {
    ...
    public T findById(String sfsd) throws Exception, SpartanPersistenceException;
}
