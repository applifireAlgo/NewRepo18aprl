...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for Mynew Master table Entity", complexity = Complexity.LOW)
public interface MynewRepository<T> extends SearchInterface {
    ...
    public T findById(String dsd) throws Exception, SpartanPersistenceException;
}
