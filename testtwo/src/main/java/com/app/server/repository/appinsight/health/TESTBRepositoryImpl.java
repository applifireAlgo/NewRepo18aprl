...
public class TESTBRepositoryImpl extends SearchInterfaceImpl implements TESTBRepository<TESTB> {
    ...
    @Override
    @Transactional
    public List<TESTB> findAll() throws SpartanPersistenceException {
        try {
    ...
    @Override
    @Transactional
    public TESTB save(TESTB entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public List<TESTB> save(List<TESTB> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(TESTB entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
    ...
    @Override
    @Transactional
    public void update(List<TESTB> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.appinsight.health.TESTB obj = entity.get(i);
    ...
    @Transactional
    public List<TESTB> findByBc(String bc) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("TESTB.findByBc");
            query.setParameter("bc", bc);
            java.util.List<com.app.shared.appinsight.health.TESTB> listOfTESTB = query.getResultList();
            return listOfTESTB;
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Transactional
    public List<TESTB> findByRrrr(String rrrr) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("TESTB.findByRrrr");
    ...
    @Transactional
    public List<TESTB> findByAddressId(String addressId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("TESTB.findByAddressId");
    ...
    @Transactional
    public List<TESTB> findByContactId(String contactId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("TESTB.findByContactId");
    ...
    @Transactional
    public TESTB findById(String aaaaa) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("TESTB.findById");
            query.setParameter("aaaaa", aaaaa);
