Ext.define('Testtwo.testtwo.web.com.controller.appinsight.health.AAMainController', {
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#AAForm');
     ...
     hideDataBrowser: function() {
          var form = this.view.down('#AAForm');
          var grid = this.view.down('#AAGrid');
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               ...
               var formPanel = this.getView().up().down('#AAForm');
               jsonData = {
                    'findKey': primaryKey
               }
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#AAForm').down('#' + me.column.dataIndex + '').store;
