Ext.define('Testtwo.testtwo.web.com.controller.appinsight.health.BBMainController', {
     extend: 'Testtwo.view.fw.frameworkController.FrameworkViewController',
     alias: 'controller.BBMainController',
     ...
     onTreeRefreshClick: function(event, toolEl, panelHeader) {
          ...
          var tree = this.view.down('#BBTree');
     ...
     hideDataBrowser: function() {
          var form = this.view.down('#BBForm');
          var grid = this.view.down('#BBGrid');
          var tree = this.view.down('#BBTreeContainer');
          grid.setHidden(true);
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               ...
               var gridPanel = this.view.up().down('#BBGrid');
               ...
               var formPanel = this.getView().up().down('#BBForm');
               jsonData = {
                    'findKey': primaryKey
               }
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          ...
          var treePanel = this.view.up().up().down('#BBTree');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#BBForm').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#BBGrid').store;
          gridStore.removeAll();
