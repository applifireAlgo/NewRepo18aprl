Ext.define('Testtwo.testtwo.web.com.controller.appinsight.health.CAMainController', {
     extend: 'Testtwo.view.fw.frameworkController.FrameworkViewController',
     alias: 'controller.CAMainController',
     ...
     onTreeRefreshClick: function(event, toolEl, panelHeader) {
          ...
          var tree = this.view.down('#CATree');
     ...
     hideDataBrowser: function() {
          var form = this.view.down('#CAForm');
          var grid = this.view.down('#CAGrid');
          var tree = this.view.down('#CATreeContainer');
          grid.setHidden(true);
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               ...
               var gridPanel = this.view.up().down('#CAGrid');
               ...
               var formPanel = this.getView().up().down('#CAForm');
               jsonData = {
                    'findKey': primaryKey
               }
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          ...
          var treePanel = this.view.up().up().down('#CATree');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#CAForm').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#CAGrid').store;
          gridStore.removeAll();
