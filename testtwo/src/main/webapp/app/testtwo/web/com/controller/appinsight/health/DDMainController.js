Ext.define('Testtwo.testtwo.web.com.controller.appinsight.health.DDMainController', {
     extend: 'Testtwo.view.fw.frameworkController.FrameworkViewController',
     alias: 'controller.DDMainController',
     ...
     onTreeRefreshClick: function(event, toolEl, panelHeader) {
          ...
          var tree = this.view.down('#DDTree');
     ...
     hideDataBrowser: function() {
          var form = this.view.down('#DDForm');
          var grid = this.view.down('#DDGrid');
          var tree = this.view.down('#DDTreeContainer');
          grid.setHidden(true);
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               ...
               var gridPanel = this.view.up().down('#DDGrid');
               ...
               var formPanel = this.getView().up().down('#DDForm');
               jsonData = {
                    'findKey': primaryKey
               }
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          ...
          var treePanel = this.view.up().up().down('#DDTree');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#DDForm').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#DDGrid').store;
          gridStore.removeAll();
