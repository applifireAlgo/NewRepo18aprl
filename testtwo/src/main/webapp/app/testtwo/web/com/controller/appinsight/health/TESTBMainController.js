Ext.define('Testtwo.testtwo.web.com.controller.appinsight.health.TESTBMainController', {
     ...
     bcLoad: function() {
          ...
          Ext.Ajax.request({
               ...
               success: function(response, scope) {
                    var compRef = scope.sender.down('#bc');
                    scope.sender.controller.assignAllComboData(scope.sender, 'bc', response.responseText);
     ...
     testOneLoad: function() {
          var scope = this.getView();
          Ext.Ajax.request({
               url: 'secure/TestOne/findAll',
               method: 'GET',
               sender: scope,
               jsonData: {},
               success: function(response, scope) {
                    var compRef = scope.sender.down('#testOne');
                    scope.sender.controller.assignAllComboData(scope.sender, 'testOne', response.responseText);
                    scope.sender.controller.addCommunicationLog(response, true, compRef);
               },
               failure: function(response, scope) {
                    var compRef = scope.sender.down('#testOne');
