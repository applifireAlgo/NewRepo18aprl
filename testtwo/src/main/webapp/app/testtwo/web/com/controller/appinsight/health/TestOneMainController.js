Ext.define('Testtwo.testtwo.web.com.controller.appinsight.health.TestOneMainController', {
     extend: 'Testtwo.view.fw.frameworkController.AggregateViewController',
     ...
     onFilterClick: function(but, evt) {
          ...
          Ext.Ajax.request({
               ...
               failure: function(response, currentObject) {
                    ...
                    var compRef = scope.sender.view.down('#TestOneTree');
