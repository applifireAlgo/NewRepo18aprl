...
public class PasswordPolicyTestCase extends EntityTestCriteria {
    ...
    private PasswordPolicy createPasswordPolicy(Boolean isSave) throws SpartanPersistenceException, SpartanConstraintViolationException {
        ...
        passwordpolicy.setAllowedSpecialLetters("7WUAteZWcJWR97yw2Lj8WKepugdHhfg5fgQGTx7BsNG6IsZ6KA");
        passwordpolicy.setMinPwdLength(5);
        passwordpolicy.setMinCapitalLetters(2);
        passwordpolicy.setMinSpecialLetters(3);
        passwordpolicy.setPolicyDescription("KzDwBRptfqoxcdcKzhtmllj5VUdUe1W8h66sHBmfkihPpKMZCI");
        passwordpolicy.setPolicyName("J05AeNqTDQVXn4msC9QmyhdfWNMIVdjpCSsDOlWcWHuNoa1Mli");
    ...
    public void test2Update() {
        try {
            ...
            passwordpolicy.setAllowedSpecialLetters("JyNAkaH0111RVX0C9PUQoqYSGTUHMbj9d8uWrbqI2KBZoJPIJg");
            passwordpolicy.setVersionId(1);
            passwordpolicy.setMinPwdLength(9);
            passwordpolicy.setMinCapitalLetters(6);
            passwordpolicy.setMinSpecialLetters(9);
            passwordpolicy.setPolicyDescription("9ngYO0fiMKJkCmN4SmRzJ9xT8Pl8Bl15ZUDPtCLhSjUvUUvyQP");
            passwordpolicy.setPolicyName("BS25w1Sqm9iJQTrZvkb9XQluTfTLfp3r6vmoQVTr5p1gdUwUfI");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "policyName", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 3, "policyDescription", ""));
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 11, "allowedSpecialLetters", ""));
