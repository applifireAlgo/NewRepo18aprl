...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws SpartanPersistenceException, SpartanConstraintViolationException {
        ...
        question.setQuestion("glE8ci4s5JCZDR0gMhEGc5NYfE9aN8VQcMgqjkZmbRg3kkalhD");
        question.setQuestionDetails("Vy3DrELsbk");
        question.setLevelid(11);
        question.setQuestionIcon("FGcWLiXgbM8adn3SS6iDbiMSikGcUhaqVncoHIvCpaGtLMrkwZ");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestion("ZEagxZV8K9dzbwZ53QmRu0fWmnA5plrvFYf1l77H8V2vkXJshB");
            question.setVersionId(1);
            question.setQuestionDetails("XIVVZIR0bl");
            question.setLevelid(1);
            question.setQuestionIcon("YDz2EPPIe0xbPi0xnuMLA00AyAJWbnN50UXoc7yJrMEqxNSwM7");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "ENhK9CzKDLYttYB2qYxEFGkTYTC7dIK8Y0XaRIRKLmpGTnonK1wLog3cSAbd6sVyu"));
