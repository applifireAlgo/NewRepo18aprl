...
public class UserTestCase extends EntityTestCriteria {
    ...
    private User createUser(Boolean isSave) throws SpartanPersistenceException, SpartanConstraintViolationException {
        ...
        useraccesslevel.setLevelHelp("Ip18XTfbXtZqjkBKpBNM3InviWXeyoCWiIJX31SdcQ31DPFdwA");
        useraccesslevel.setUserAccessLevel(valueGenerator.getRandomInteger(99999, 0));
        useraccesslevel.setLevelIcon("5dVgr3NWMSa4jfr4rXLZsHamggFpR3p8tPHq9yvFecxyPlFNkI");
        useraccesslevel.setLevelDescription("GImFuLAKgkIvMiSg61MlaJQtYBQyKyVw4gqAZjVTET0GMnGTna");
        useraccesslevel.setLevelName("dMxGmkybOGrQ0rMiFbthikUdy7yxjcXrq76iOd65UaqBRoyl8b");
        ...
        useraccessdomain.setDomainName("0dSj2YpbWmV12e6bGFMNBCLpf1aeQDDar24pspF3s0YQpbmPPU");
        useraccessdomain.setDomainIcon("mo3qwKf38HEmDXkU3uM090RSzmCoJ8Y2oOV8CLzj8agR9UAJXw");
        useraccessdomain.setUserAccessDomain(valueGenerator.getRandomInteger(99999, 0));
        useraccessdomain.setDomainDescription("HseB0t5vF7ZBkU99OCTpxtZtFv1MHGCLBgOJhlz4qB84p96TE0");
        useraccessdomain.setDomainHelp("nPcwJcx4mxvYGR4wcDDiHQVm09rCBGVF5So1m4Fixc0t7WbMxE");
        ...
        User user = new User();
        user.setPasswordAlgo("4MkFVe89IOPjrNQJYGzNWOa8w5RugPErIRNFL9srPVfb6uiCdF");
        user.setGenTempOneTimePassword(1);
        user.setUserAccessLevelId((java.lang.String) UserAccessLevelTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setIsDeleted(1);
        user.setPasswordExpiryDate(new java.sql.Timestamp(1460975172699l));
        user.setMultiFactorAuthEnabled(1);
        user.setAllowMultipleLogin(1);
        user.setChangePasswordNextLogin(1);
        user.setUserAccessDomainId((java.lang.String) UserAccessDomainTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setIsLocked(1);
        user.setSessionTimeout(3345);
        user.setUserAccessCode(2036);
        user.setLastPasswordChangeDate(new java.sql.Timestamp(1460975172745l));
        java.util.List<PassRecovery> listOfPassRecovery = new java.util.ArrayList<PassRecovery>();
        PassRecovery passrecovery = new PassRecovery();
        Question question = new Question();
        question.setQuestion("6old1pU9VHACyG6LXYGfQAbmJ7p4z5FFt4XaKF85pTnxV07DYX");
        question.setQuestionDetails("qG2bqC4XEZ");
        question.setLevelid(2);
        question.setQuestionIcon("8AhIuBim9y0q64tjPznKhB0jakdDg3rV2Vy2YlPrLbBGAOqw9L");
        ...
        passrecovery.setAnswer("QKBZwyOdLcE2myLtHPApzRfEQojM6evvHvNRHzUgMWFo5KeLuG");
        passrecovery.setUser(user);
        listOfPassRecovery.add(passrecovery);
        user.addAllPassRecovery(listOfPassRecovery);
        UserData userdata = new UserData();
        userdata.setLast5Passwords("ohuSwv0qBWcnYMnXBxpMxYZk3p3bOr8VCBwuYKnUJL8r25UZLg");
        userdata.setOneTimePassword("Yj8o1VfwH2zPAff6fJetUpcI0BXgfAag");
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1460975172931l));
        userdata.setPassword("UvJz0SDmS1D2EBRKOTJaK5eEK1A1JrgfGwJNzkRT2VnZTioqZt");
        userdata.setLast5Passwords("hiVyZwn80LAyB84RPqRxNbKkfETDccYU5OCn31v2rrHSXrSQSb");
        userdata.setOneTimePassword("ecrD1Vzy57XEeGnNi5Q8yucf5f8At93I");
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1460975172942l));
        userdata.setPassword("VtyHbK5eCXzTjg6DozxgB0yPGeOdTFzUDnkGPhyop8Wm9c60Ai");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 1, "userAccessCode", 118085));
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 8, "passwordAlgo", "QMcqmQbJYczIqe7GSso40cxBxPzcJG5AzPiyDNZ3O1vHj877H7Zcw9iT6arrYcXfA"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 9, "sessionTimeout", 6805));
