package com.app.server.businessservice.newreportbc.newreport.aspect;
...
@Aspect
@Component
public class BusinessServicenewreportAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* com.app.server.businessservice.newreportbc.newreport..*(..))")
