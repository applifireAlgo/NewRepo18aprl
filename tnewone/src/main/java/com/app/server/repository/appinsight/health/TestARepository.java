...
public interface TestARepository<T> extends SearchInterface {
    ...
    public List<T> findByTgen(String tgen) throws Exception, SpartanPersistenceException;

    public T findById(String tt) throws Exception, SpartanPersistenceException;
}
