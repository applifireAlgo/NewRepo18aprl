package com.app.server.repository.newreportbc.newreport.aspect;
...
@Aspect
@Component
public class RepositorynewreportAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* com.app.server.repository.newreportbc.newreport..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.newreportbc.newreport..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.newreportbc.newreport..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.newreportbc.newreport..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.newreportbc.newreport..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.newreportbc.newreport..*(..))")
