package com.app.server.service.newreportbc.newreport.aspect;
...
@Aspect
@Component
public class ServicenewreportAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* com.app.server.service.newreportbc.newreport..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.app.server.service.newreportbc.newreport..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.app.server.service.newreportbc.newreport..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.app.server.service.newreportbc.newreport..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.app.server.service.newreportbc.newreport..get*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.app.server.service.newreportbc.newreport..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
