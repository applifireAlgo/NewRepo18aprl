...
@SourceCodeAuthorClass(createdBy = "shweta.zagade@algorhythm.co.in", updatedBy = "shweta.zagade@algorhythm.co.in", versionNumber = "7", comments = "TestA", complexity = Complexity.LOW)
...
public class TestA implements Serializable, CommonEntityInterface, Comparator<TestA> {
    ...
    public void setTgen(String _tgen) {
        this.tgen = _tgen;
    }
