 ...
 */
Ext.define('Tnewone.Application', {
	...
	requires : [ "Ext.ux.BoxReorderer", "Ext.ux.CellDragDrop",
			...
			"Ext.ProgressBarWidget", "Ext.ZIndexManager","Tnewone.view.databrowsercalendar.DBCalendar"],
	...
	stores : [ 'Tnewone.store.QueryCriteriaWidgetsStore' ],
	...
	try {
		...
		if (responseData.response) {
			if (responseData.response.exceptionId == 4005 && !sessionTimeOutFlag) {
				...
				var loginWindow = Ext.create('Tnewone.view.login.SessionLogin').center();
