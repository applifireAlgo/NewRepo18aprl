Ext.define('Tnewone.tnewone.web.com.controller.appinsight.health.StwoMainController', {
     extend: 'Tnewone.view.fw.frameworkController.FrameworkViewController',
     alias: 'controller.StwoMainController',
     ...
     onTreeRefreshClick: function(event, toolEl, panelHeader) {
          ...
          var tree = this.view.down('#StwoTree');
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#StwoForm');
          this.updateFormUI(formPanel, 'Save', true); /** Adding data to tree and grid */
          if (data != null) {
               var grid = this.view.down('#StwoGrid');
               var tree = this.view.down('#StwoTree');
               if (method == 'PUT') {
     ...
     hideDataBrowser: function() {
          var form = this.view.down('#StwoForm');
          var grid = this.view.down('#StwoGrid');
          var tree = this.view.down('#StwoTreeContainer');
          grid.setHidden(true);
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               ...
               var gridPanel = this.view.up().down('#StwoGrid');
               ...
               var formPanel = this.getView().up().down('#StwoForm');
               jsonData = {
                    'findKey': primaryKey
               }
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          ...
          var treePanel = this.view.up().up().down('#StwoTree');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#StwoForm').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#StwoGrid').store;
          gridStore.removeAll();
