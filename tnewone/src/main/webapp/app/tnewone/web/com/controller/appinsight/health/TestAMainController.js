Ext.define('Tnewone.tnewone.web.com.controller.appinsight.health.TestAMainController', {
     ...
     tgenLoad: function() {
          ...
          Ext.Ajax.request({
               ...
               success: function(response, scope) {
                    var compRef = scope.sender.down('#tgen');
                    scope.sender.controller.assignAllComboData(scope.sender, 'tgen', response.responseText);
