Ext.define("Tnewone.view.clouddrive.CloudDrive", {
	extend : 'Ext.panel.Panel',
	xtype : 'clouddrive',
	requires : [ 'Tnewone.view.clouddrive.CloudDriveController',
	             'Tnewone.view.clouddrive.documentview.DocumentsView',
	             'Tnewone.view.clouddrive.drivedetails.DriveDetails',
	             //'Tnewone.view.clouddrive.documentview.DocumentListView'
	             ],
