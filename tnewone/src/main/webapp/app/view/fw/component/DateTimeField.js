 ...
 */
Ext.define('Tnewone.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Tnewone.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Tnewone.view.fw.component.DateTimePicker(o);
    },
