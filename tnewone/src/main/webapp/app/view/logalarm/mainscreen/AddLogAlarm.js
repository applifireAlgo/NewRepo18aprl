 ...
 * 
 */
Ext.define('Tnewone.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Tnewone.view.logalarm.mainscreen.AddLogAlarmController',
			'Tnewone.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Tnewone.view.logalarm.mainscreen.AppAlarmPanel',
