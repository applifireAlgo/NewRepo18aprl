...
Ext
		.define(
				'Tnewone.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Tnewone.view.logger.tabs.details.DetailsTab',
							'Tnewone.view.logger.tabs.fileconnector.FileConnectorTab',
							'Tnewone.view.logger.tabs.dbconnector.DBConnectorTab',
							'Tnewone.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Tnewone.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Tnewone.view.logger.LogConfigurationTabPanelController',
