 ...
 * 
 */
Ext.define('Tnewone.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Tnewone.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
