Ext
		.define(
				'Tnewone.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Tnewone.view.searchengine.search.SearchEngineMainPanelController','Tnewone.view.searchengine.search.PanelHeaderField' ,'Tnewone.view.searchengine.search.ReportGridView','Tnewone.view.searchengine.search.ReportChartView','Tnewone.view.searchengine.search.documentView','Tnewone.view.searchengine.search.DouMeanView','Tnewone.view.googlemaps.map.MapPanel'],
