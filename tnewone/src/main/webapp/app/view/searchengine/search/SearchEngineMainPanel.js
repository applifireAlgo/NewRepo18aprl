Ext.define('Tnewone.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Tnewone.view.searchengine.search.NorthPanel', 'Tnewone.view.searchengine.search.SearchResult','Tnewone.view.searchengine.search.SearchEngineMainPanelController'],
