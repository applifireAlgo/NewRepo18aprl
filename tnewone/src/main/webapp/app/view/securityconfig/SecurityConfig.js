 ...
 * 
 */
Ext.define('Tnewone.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Tnewone.view.securityconfig.SecurityConfigController',
			'Tnewone.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
