Ext.define('Tnewone.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Tnewone.view.usermanagement.admin.AddUserDetailsViewModel', 'Tnewone.model.AddUserDataModel' ],
