Ext.define('Tnewone.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Tnewone.view.usermanagement.enduser.UserProfileController', 'Tnewone.view.usermanagement.admin.AddUserDetailsViewModel', 'Tnewone.model.AddUserDataModel' ],
