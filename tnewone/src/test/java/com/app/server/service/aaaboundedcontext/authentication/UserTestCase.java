...
public class UserTestCase extends EntityTestCriteria {
    ...
    private User createUser(Boolean isSave) throws SpartanPersistenceException, SpartanConstraintViolationException {
        ...
        useraccessdomain.setDomainDescription("8STzPCppWKj54UeKR5SURdCtaOyYSusx1jL5POIo18i5x5z9m9");
        useraccessdomain.setDomainName("C8JhD4uL6WoYyj8aQnLk5tug64yH8lPLjiPIeWRdznGQ0l8tXu");
        useraccessdomain.setDomainHelp("PMbC5Eb9wl63TkuTSdbrqkV91U4MHj423PiNO2ZdXxoTyeaynb");
        useraccessdomain.setUserAccessDomain(valueGenerator.getRandomInteger(99999, 0));
        useraccessdomain.setDomainIcon("CLULQO6IZAvytY5OTAe56p7gbj9H12uw4J8UMpBnCmlcLz5PdB");
        ...
        useraccesslevel.setLevelName("CYCYAMKjn5kR1wE197NugGmKKuqbsLvNModZZkjG6FsYFtlPnN");
        useraccesslevel.setLevelDescription("DacugfYYJr85IySl1WeN9csflq9UlROy28kH1iTQCOAWlmi4CG");
        useraccesslevel.setLevelHelp("CP843PfNdZ9Ptk4eYaOVr5VzrrH1jAAEn9twQOCIKoqlj2XtIp");
        useraccesslevel.setUserAccessLevel(valueGenerator.getRandomInteger(99999, 0));
        useraccesslevel.setLevelIcon("UyDVOhvMBjm5FHaIeQBY25IudrF6V1NlI1aAXL2ZsbtpoqERCX");
        ...
        User user = new User();
        user.setLastPasswordChangeDate(new java.sql.Timestamp(1461247756440l));
        user.setPasswordAlgo("Au3jUgq3efm2dP5tpSZ5uQTkwcEIhIWd28al5J59egW2JlwsVr");
        user.setUserAccessDomainId((java.lang.String) UserAccessDomainTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setSessionTimeout(2356);
        user.setChangePasswordNextLogin(1);
        user.setIsDeleted(1);
        user.setUserAccessCode(4067);
        user.setAllowMultipleLogin(1);
        user.setMultiFactorAuthEnabled(1);
        user.setGenTempOneTimePassword(1);
        user.setUserAccessLevelId((java.lang.String) UserAccessLevelTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setPasswordExpiryDate(new java.sql.Timestamp(1461247756498l));
        user.setIsLocked(1);
        java.util.List<PassRecovery> listOfPassRecovery = new java.util.ArrayList<PassRecovery>();
        PassRecovery passrecovery = new PassRecovery();
        Question question = new Question();
        question.setQuestionDetails("6WQmMyQGgi");
        question.setLevelid(7);
        question.setQuestionIcon("DK8fxsoxNsH9gLOv3E3TyTdMjITnQydZxGO1SoMOwItpDNQHXT");
        question.setQuestion("iGdaGELSrgNBepuHPprVwBVImG0L99yKrOy8vil0IPsyrkDgR5");
        ...
        passrecovery.setAnswer("JDUV8VlnNbbj7KQoAPxQkc9BogZ7qvljc0vghiLQgqAZUrqfub");
        listOfPassRecovery.add(passrecovery);
        user.addAllPassRecovery(listOfPassRecovery);
        UserData userdata = new UserData();
        userdata.setUser(user);
        userdata.setOneTimePasswordExpiry(9);
        userdata.setOneTimePassword("c5YoH6ivjvETGhrVPAxE4FsaCa9ZoQNM");
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1461247756735l));
        userdata.setLast5Passwords("Wpgf0XXQT1KxWhE6D94R1PVblG0z9gElgJWin5rdVSMOYimGHz");
        userdata.setPassword("9iEaYZZzNlBJU8vPtT7GwyfZAT1dzM7DRATkOOQy8i8dMBWVp2");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 8, "passwordAlgo", "spByGFMamMvxowCyCbGnSuxf6lA7Aqzj610rXrsYS0nErOPRN6bi5ZC8vpr5cOVRK"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 9, "sessionTimeout", 4376));
