...
public class TitleTestCase extends EntityTestCriteria {
    ...
    private Title createTitle(Boolean isSave) throws SpartanPersistenceException, SpartanConstraintViolationException {
        ...
        title.setTitles("WQeDrcre1sJAlv0oumWyGymH4mrBw7ov36qtLLqWdNV8dRe1fM");
    ...
    public void test2Update() {
        try {
            ...
            title.setTitles("NJxh6oUgjaTnV0jU1k8LySLTuLHK1uQsm5P6VrkqXl5apI1Yv2");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "titles", ""));
