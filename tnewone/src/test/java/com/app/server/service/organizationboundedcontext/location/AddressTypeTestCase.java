...
public class AddressTypeTestCase extends EntityTestCriteria {
    ...
    private AddressType createAddressType(Boolean isSave) throws SpartanPersistenceException, SpartanConstraintViolationException {
        ...
        addresstype.setAddressType("5iTalMRU4omuwgIt9C09fwMps4deRxlRPH2dDHoTVLUOpd2H2o");
        addresstype.setAddressTypeDesc("INskOtnTFJjXP1qtAKD24LW2iJ3dLVbDGtD6ybtUvqR7rBc5TC");
        addresstype.setAddressTypeIcon("quwSt7s6Bo4On7eeelPgggPUEU29LWJbHAjaNHhKMt4GXAJLkU");
    ...
    public void test2Update() {
        try {
            ...
            addresstype.setAddressType("s6ojDTWyEpRfS1skWhtiFrhV1xdGppgbYVZtWYdkmjzrCx1Mrp");
            addresstype.setAddressTypeDesc("UURWOU8qvEYuIrBHGgYGaOracelQdUny7TsJjfDD35Ed8Xdsyg");
            addresstype.setAddressTypeIcon("8hAvqQ7IHcpoWSbQKcLoJrajVRf4hZ3cA4DYWsSamBlpJkmdhZ");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "addressType", "lQtnjKiTIiES1L0sEKKRs8y30ww8KyR0aMlWM0bgdqD1MDUqaz9kVP9hxBWyYGaQq7M7lHTQgTNqfKWXdUwjhlYWcBxIz18H1ckoQq8cAzUnTKwOMiYvN21SnOWQnm3QI"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 3, "addressTypeDesc", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "addressTypeIcon", "fO4BRuTOspv6pyaCb14W0rFM7zGGo2txA2xFFEhqUoT1P5FQs1cQMl9BIqEUPxylq7F8FpKF0n6YXpJMa1pb6cYR80PzGt9QBXJXD0fjdpdaS6HBmRSfIcWfXwMJvPFEo"));
